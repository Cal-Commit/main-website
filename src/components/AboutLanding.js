...
function AboutLandingComp() {
    return (
        ...
        <div className="mt-8 sm:mt-12 md:mt-16 lg:mt-20 max-w-full w-11/12 sm:w-10/12 md:w-8/12 lg:w-4/5 mx-auto flex flex-col md:flex-row justify-between items-center">
            
            <div className="mb-6 sm:mb-8 md:mb-0 md:w-2/5">
